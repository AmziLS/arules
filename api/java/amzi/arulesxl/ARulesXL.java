...
public class ARulesXL {
	private ARulesLogicServer ls = null;
	...
	public ARulesLogicServer getLS() {
		return ls;
	}
	...
	public Vector queryRulesToStringList(String ruleset, String query) throws Exception {
		...
		try {
			...
			if (type != ARulesLogicServer.pLIST) {
	...
	private String formatLSException(ARulesLSException ex) {
		String msg, lineno;
		
		if (ex.GetType() == ARulesLSException.READ) {
